...
const EventSummary = () => {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/event_registration_app/registration-stats/');
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/event_registration_app/pending_stats/');
    ...
    return (
        ...
        <div className="summary-content1">
            ...
            <p>Total: {stats.total_users + stats.total_guests}</p>
        </div>
        ...
        <div className="summary-content2">
            ...
            <p>Total: {user.total_users + user.total_guests}</p>
        </div>
        ...
        <div className="summary-content3">
            ...
            <p>Total: {user.total_users + user.total_guests+stats.total_users + stats.total_guests}</p>
        </div>
